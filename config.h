...
static const Gap default_gap        = {.isgap = 1, .realgap = 18, .gappx = 18};
...
static const char *roficmd[] = { "rofi", "-show", "drun", "-show-emojis", "-show-icons", "-dpi", "141", NULL };
